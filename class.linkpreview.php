        ...
        <table id="at_preview">
            <tbody>
                <tr>
                    <td width="100">
                        <img width="100" 
                             data-src = "<?php $URLPreview->getImage(1); ?>" 
                             src="<?php $URLPreview->getImage();  ?>">
                    </td>
                    <td style="vertical-align: top;">
                        <span><strong><?php $URLPreview->getTitle();  ?></strong></span>
                        <span style="display: block;margin-top: 8px;"><?php $URLPreview->getDescription();  ?></span>
                    </td>
                </tr>
                <tr class="preview_footer">
                    <td colspan="2">
                        <span>Source:
                            <a href="<?php echo $URLPreview->url; ?>"><?php echo preg_replace('#^https?://#', '', $URLPreview->url);  ?>
                            </a>
                        </span>
                    </td>
                </tr>
